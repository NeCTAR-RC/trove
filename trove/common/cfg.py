...
common_opts = [
    ...
    cfg.StrOpt('nova_proxy_admin_user_domain_name', default='Default',
               help="Admin user domain name used to connect to Nova."),
    cfg.StrOpt('nova_proxy_admin_project_domain_name', default='Default',
               help="Admin project domain name used to connect to Nova."),
    ...
    cfg.StrOpt('flavor_filter', default=None,
               help='Filter flavor list to only show flavors with this'
